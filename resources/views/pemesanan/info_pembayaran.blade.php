            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <p class="text-success mb-1" style="font-size: 20px"><b>Rp 500.000</b></p>
                ...
                <div class="row">
                    ...
                    <div class="col-4 text-center mt-1">
                        <p class="text-dark" style="font-size: 22px; margin-left: 30%">032-606 111 565 <i class="bi bi-clipboard"></i></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-11 mt-1">
                        <p style="margin-right: 20%">Demi keamanan transaksi mohon untuk tidak membagikan bukti atau Konfirmasi
                            pembayaran pesanan kepada pihak mana pun
                    </div>
                </div>
                <div class="d-grid gap-2 col-6 mx-auto">
                    <a class="btn btn-outline-success" href="/pemesanan/buktipembayaran" role="button">Upload bukti transfer</a>
