                                ...
                                <table class="table">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col text-muted">Kriteria Kost</th>
                                        <th scope="col text-muted">Harga Sewa</th>
                                          ...
                                          <div class="mb-3" style="max-width: 430px">
                                            <div class="row g-0">
                                              <div class="col-4 mt-2">
                                                <img src="{{ asset('img/.png') }}" class="img-fluid rounded-start" alt="...">
                                              </div>
                                              <div class="col-md-8">
                                                <div class="card-body">
                                                  <p class="mb-2" style="font-size: 16px; margin-bottom: 9px">
                                                    <b>Lestari kost | Abad - kostjogja</b>
                                                  </p>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-body">
                                  <p>Yakin ingin menghapus 1 kost?</p>
