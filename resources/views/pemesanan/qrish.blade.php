            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <p class="mb-1 text-secondary" style="font-size: 17px;">Transfer dapat dilakukan dengan scan barcode dibawah ini :</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 text-center mt-2 mb-4">
                        <img src="{{ asset('assets/img/qrish.jpg') }}" alt="bca" width="25%">
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-11 mt-1">
                        <p style="margin-right: 20%">Gunakan e-wallet dan mBanking apa saja yang ada di device kalian</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1">
                ...
                <div class="row">
                    ...
                    <div class="col-11 mt-1">
                        <p style="margin-right: 20%">Demi keamanan transaksi mohon untuk tidak membagikan bukti atau Konfirmasi
                            pembayaran pesanan kepada siapa pun
                        </p>
                    </div>
                </div>
